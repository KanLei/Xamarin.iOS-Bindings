...
- (void)viewDidLoad {
    ...
    //mmtime   修改确定按钮的确认前 和确认后
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:(254/255.0) green:(81/255.0) blue:(81/255.0) alpha:1.0];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(170/255.0) green:(170/255.0) blue:(170/255.0) alpha:0.5];
...
- (void)configBarButtonItemAppearance {
    ...
    //mmtime 恢复 navigation item title 的颜色为黑色
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc {
    ...
    if (self) {
        ...
        self.miniDuration = 0.0;  // mmtime: 增加视频选择时长限制
...
- (void)configDefaultImageName {
    ...
    self.takeVideoImageName = @"takeVideo.png";  // mmtime: 增加视频拍摄图片
...
- (void)configDefaultBtnTitle {
    self.doneBtnTitleStr = [NSBundle tz_localizedStringForKey:@"确定"];
    self.cancelBtnTitleStr = [NSBundle tz_localizedStringForKey:@"取消"];
    self.previewBtnTitleStr = [NSBundle tz_localizedStringForKey:@"预览"];
    self.fullImageBtnTitleStr = [NSBundle tz_localizedStringForKey:@"原图"];
    self.settingBtnTitleStr = [NSBundle tz_localizedStringForKey:@"设置"];
    self.processHintStr = [NSBundle tz_localizedStringForKey:@"正在处理..."];
}
...
// mmtime: 增加最小时长
- (void)setMiniDuration:(CGFloat)miniDuration {
    [TZImageManager manager].miniDuration = miniDuration;
}
...
//    [super pushViewController:viewController animated:animated];
    ...
    if (self.childViewControllers.count > 0) {
        ...
        self.topViewController.navigationController.navigationBar.tintColor = [UIColor blackColor];
        
         //替换 back item image
        UIImage *backImage =[UIImage imageNamedFromMyBundle:@"navi_back.png"];
        self.topViewController.navigationController.navigationBar.backIndicatorImage = backImage;
        self.topViewController.navigationController.navigationBar.backIndicatorTransitionMaskImage = backImage;
     }
    [super pushViewController:viewController animated:animated];
}
