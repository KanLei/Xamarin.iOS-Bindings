...
/// Default is 0.0
@property (nonatomic, assign) CGFloat miniDuration;  // mmtime: 增加默认最小时长

/// Defaut is
@property (nonatomic, assign) CGFloat maxDuration;  // mmtime: 增加默认最大时长
...
@property (nonatomic, copy) NSString *takeVideoImageName;
...
// mmtime  视频拍摄按钮 拍摄回调
@property (nonatomic, copy) void (^takeMoviePlay)(TZImagePickerController* picker,UIViewController* oldViewController);
- (void)takeMoviePlay:(TZImagePickerController *)picker oldViewController:(UIViewController *) oldViewController ;
