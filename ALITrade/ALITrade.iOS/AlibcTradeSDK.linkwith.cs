...
[assembly: LinkWith ("AlibcTradeSDK.a", LinkTarget.Simulator | LinkTarget.Simulator64 | LinkTarget.ArmV7 | LinkTarget.Arm64, SmartLink = true, ForceLoad = true,
    Frameworks = "CoreMotion CFNetwork Security SystemConfiguration CoreTelephony",
    LinkerFlags = "-lsqlite3.0 -lstdc++ -ObjC")]